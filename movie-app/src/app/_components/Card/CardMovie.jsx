...
export default function CardMovie({
  ...
  return (
    <article className="h-full flex flex-col gap-1 cursor-pointer overflow-hidden">
      <div className="flex-1 w-full relative group">
        ...
        <FaPlay className="opacity-0 group-hover:opacity-100 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-4xl transition-all" />
      </div>
      <div>
